//Viết các đoạn code liên quand đến trang giỏ hàng
...
//Hét lấy data và in ra giao diện.
    ...
    fetch("/order", {
      ...
      .then(data => {
        if (data.code === 200) {
          ...
          window.location.href = `/order/success?orderCode=${data.orderCode}`; // chuyen huong sang trang dat hang thanh cong
        } else {  
